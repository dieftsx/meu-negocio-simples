...
const TIPOS_NEGOCIO = [
  { value: 'alimentacao', label: 'Alimentacao (Restaurante, Lanchonete, Marmitex)' },
            ...
            <CardContent>
              <form onSubmit={step === 2 ? handleSubmit : (e) => { e.preventDefault(); handleNext(); }}>
                {step === 1 ? (
                  <FieldGroup>
                    <Field>
                      <FieldLabel htmlFor="nomeResponsavel">Seu nome</FieldLabel>
                      <Input
                        id="nomeResponsavel"
                        type="text"
                    ...
                    <Field>
                      <FieldLabel htmlFor="nomeEmpresa">Nome do seu negocio</FieldLabel>
                      <Input
                        id="nomeEmpresa"
                        type="text"
                    ...
                    <Field>
                      <FieldLabel htmlFor="tipoNegocio">Tipo de negocio</FieldLabel>
                      <Select
                        value={formData.tipoNegocio}
                        onValueChange={(value) => updateForm('tipoNegocio', value)}
                      >
